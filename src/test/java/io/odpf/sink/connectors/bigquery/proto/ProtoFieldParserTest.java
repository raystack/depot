...
public class ProtoFieldParserTest {
    ...
    public void shouldThrowExceptionIfNestedProtoNotFound() {
        Map<String, Descriptors.Descriptor> descriptorMap = new HashMap<String, Descriptors.Descriptor>() {{
            put("io.odpf.sink.connectors.TestMessageBQ", TestMessageBQ.getDescriptor());
        }};
        ProtoField protoField = new ProtoField();
        protoMappingParser.parseFields(protoField, "io.odpf.sink.connectors.TestNestedMessageBQ", descriptorMap, new HashMap<>());
    }
    ...
    public void shouldParseProtoSchemaForNonNestedFields() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            put(".odpf.sink.connectors.TestMessageBQ.CurrentStateEntry", "io.odpf.sink.connectors.TestMessageBQ.CurrentStateEntry");
        ...
        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "io.odpf.sink.connectors.TestMessageBQ", descriptorMap, typeNameToPackageNameMap);
    ...
    public void shouldParseProtoSchemaForRecursiveFieldTillMaxLevel() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            put(".odpf.sink.connectors.TestRecursiveMessageBQ", "io.odpf.sink.connectors.TestRecursiveMessageBQ");
        }};

        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "io.odpf.sink.connectors.TestRecursiveMessageBQ", descriptorMap, typeNameToPackageNameMap);
    ...
    public void shouldParseProtoSchemaForNestedFields() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            ...
            put(".google.protobuf.Duration", "com.google.protobuf.Duration");
            put(".google.type.Date", "com.google.type.Date");
            put(".odpf.sink.connectors.TestMessageBQ", "io.odpf.sink.connectors.TestMessageBQ");
        }};

        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "io.odpf.sink.connectors.TestNestedMessageBQ", descriptorMap, typeNameToPackageNameMap);
