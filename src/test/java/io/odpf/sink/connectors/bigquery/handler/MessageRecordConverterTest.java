...
public class MessageRecordConverterTest {
    ...
    public void setUp() throws IOException {
        ...
        schema = protoOdpfMessageParser.getSchema("io.odpf.sink.connectors.TestMessage");
    ...
    public void shouldReturnInvalidRecordsWhenUnknownFieldsFound() throws IOException {
        ...
        when(mockParser.parse(consumerRecord, InputSchemaMessageMode.LOG_MESSAGE, "io.odpf.sink.connectors.TestMessage")).thenReturn(parsedOdpfMessage);
