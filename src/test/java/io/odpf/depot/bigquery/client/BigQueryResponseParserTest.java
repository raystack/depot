...
public class BigQueryResponseParserTest {
    ...
    public void shouldParseResponse() {
        ...
        Record record1 = new Record(TestOdpfMessageBuilder.withMetadata(record1Offset).createConsumerRecord("order-1", "order-url-1", "order-details-1").getMetadata(), new HashMap<>(), 0, null);
        Record record2 = new Record(TestOdpfMessageBuilder.withMetadata(record2Offset).createConsumerRecord("order-2", "order-url-2", "order-details-2").getMetadata(), new HashMap<>(), 1, null);
        Record record3 = new Record(TestOdpfMessageBuilder.withMetadata(record3Offset).createConsumerRecord("order-3", "order-url-3", "order-details-3").getMetadata(), new HashMap<>(), 2, null);
        Record record4 = new Record(TestOdpfMessageBuilder.withMetadata(record4Offset).createConsumerRecord("order-4", "order-url-4", "order-details-4").getMetadata(), new HashMap<>(), 3, null);
        Record record5 = new Record(TestOdpfMessageBuilder.withMetadata(record5Offset).createConsumerRecord("order-5", "order-url-5", "order-details-5").getMetadata(), new HashMap<>(), 4, null);
        Record record6 = new Record(TestOdpfMessageBuilder.withMetadata(record6Offset).createConsumerRecord("order-6", "order-url-6", "order-details-6").getMetadata(), new HashMap<>(), 5, null);
