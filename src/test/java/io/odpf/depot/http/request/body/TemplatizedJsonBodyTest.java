...
public class TemplatizedJsonBodyTest {
    ...
    public void setup() throws IOException {
        ...
        configuration.put("SINK_CONNECTOR_SCHEMA_PROTO_MESSAGE_CLASS", "io.odpf.depot.TestTypesMessage");
        configuration.put("SINK_CONNECTOR_SCHEMA_PROTO_KEY_CLASS", "io.odpf.depot.TestMessage");
        ...
        TestTypesMessage testTypesMessage = TestTypesMessage.newBuilder()
                ...
                .build();
        OdpfMessage message = new OdpfMessage(testMessage.toByteArray(), testTypesMessage.toByteArray());
