...
public class DurationFieldTest {
    ...
    public void shouldReturnDurationListString() throws InvalidProtocolBufferException {
        ...
        messages.add(DynamicMessage.parseFrom(duration1.getDescriptorForType(), duration1.toByteArray()));
        messages.add(DynamicMessage.parseFrom(duration2.getDescriptorForType(), duration2.toByteArray()));
        messages.add(DynamicMessage.parseFrom(duration3.getDescriptorForType(), duration3.toByteArray()));
        messages.add(DynamicMessage.parseFrom(duration4.getDescriptorForType(), duration4.toByteArray()));
