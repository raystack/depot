...
import io.odpf.depot.TestRecursiveMessageBQ;
...
public class ProtoFieldParserTest {
    ...
    public void shouldThrowExceptionIfNestedProtoNotFound() {
        Map<String, Descriptors.Descriptor> descriptorMap = new HashMap<String, Descriptors.Descriptor>() {{
            put("io.odpf.depot.TestMessageBQ", TestMessageBQ.getDescriptor());
        }};
        ProtoField protoField = new ProtoField();
        protoMappingParser.parseFields(protoField, "io.odpf.depot.TestNestedMessageBQ", descriptorMap, new HashMap<>());
    }
    ...
    public void shouldParseProtoSchemaForNonNestedFields() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            put(".odpf.depot.TestMessageBQ.CurrentStateEntry", "io.odpf.depot.TestMessageBQ.CurrentStateEntry");
        ...
        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "io.odpf.depot.TestMessageBQ", descriptorMap, typeNameToPackageNameMap);
    ...
    public void shouldParseProtoSchemaForRecursiveFieldTillMaxLevel() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            put(".odpf.depot.TestRecursiveMessageBQ", "io.odpf.depot.TestRecursiveMessageBQ");
        }};

        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "io.odpf.depot.TestRecursiveMessageBQ", descriptorMap, typeNameToPackageNameMap);
    ...
    public void shouldParseProtoSchemaForNestedFields() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            ...
            put(".google.protobuf.Duration", "com.google.protobuf.Duration");
            put(".google.type.Date", "com.google.type.Date");
            put(".odpf.depot.TestMessageBQ", "io.odpf.depot.TestMessageBQ");
        }};

        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "io.odpf.depot.TestNestedMessageBQ", descriptorMap, typeNameToPackageNameMap);
