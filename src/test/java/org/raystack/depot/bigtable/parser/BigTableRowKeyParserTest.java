...
public class BigTableRowKeyParserTest {
    ...
    public void shouldReturnParsedRowKeyForValidParameterisedTemplate() throws IOException, InvalidTemplateException {
        ...
        ProtoMessageParser messageParser = new ProtoMessageParser(sinkConfig,
                new StatsDReporter(new NoOpStatsDClient()), null);
        MessageSchema schema = messageParser.getSchema(sinkConfig.getSinkConnectorSchemaProtoMessageClass(),
                descriptorsMap);
        ...
        ParsedMessage parsedMessage = messageParser.parse(message, SinkConnectorSchemaMessageMode.LOG_MESSAGE,
    ...
    public void shouldThrowErrorForInvalidTemplate() throws IOException {
        ...
        InvalidTemplateException illegalArgumentException = Assertions.assertThrows(InvalidTemplateException.class,
