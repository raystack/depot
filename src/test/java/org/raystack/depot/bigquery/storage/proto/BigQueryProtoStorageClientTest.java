...
public class BigQueryProtoStorageClientTest {
        ...
        public void setUp() throws IOException, Descriptors.DescriptorValidationException {
                System.setProperty("SINK_CONNECTOR_SCHEMA_PROTO_MESSAGE_CLASS", "org.raystack.depot.TestMessageBQ");
                ...
                testMessageBQSchema = TableSchema.newBuilder()
                                ...
                                .addFields(TableFieldSchema.newBuilder()
                                                ...
                                                .build())
                                .build();
                testDescriptor = BQTableSchemaToProtoDescriptor
                                .convertBQTableSchemaToProtoDescriptor(testMessageBQSchema);
        ...
        public void shouldConvertPrimitiveFields() throws Exception {
                ...
                Assert.assertEquals("order-no-112",
                                convertedMessage.getField(testDescriptor.findFieldByName("order_number")));
                Assert.assertEquals("order-url-1",
                                convertedMessage.getField(testDescriptor.findFieldByName("order_url")));
                Assert.assertEquals(1200L, convertedMessage.getField(testDescriptor.findFieldByName("discount")));
                Assert.assertEquals(ByteString.copyFrom("test-token".getBytes()),
                                convertedMessage.getField(testDescriptor.findFieldByName("user_token")));
        ...
        public void shouldReturnDurationField() throws IOException {
                ...
                ByteString serializedRows = protoPayload.getSerializedRows(0);
                DynamicMessage convertedMessage = DynamicMessage.parseFrom(testDescriptor, serializedRows);
                DynamicMessage tripDuration = ((DynamicMessage) convertedMessage
                                .getField(testDescriptor.findFieldByName("trip_duration")));
                Assert.assertEquals(1234L,
                                tripDuration.getField(tripDuration.getDescriptorForType().findFieldByName("seconds")));
                Assert.assertEquals(231L,
                                tripDuration.getField(tripDuration.getDescriptorForType().findFieldByName("nanos")));
        }
        ...
        public void shouldReturnMapField() throws Exception {
                ...
                ByteString serializedRows = protoPayload.getSerializedRows(0);
                DynamicMessage convertedMessage = DynamicMessage.parseFrom(testDescriptor, serializedRows);
                List<Object> currentState = ((List<Object>) convertedMessage
                                .getField(testDescriptor.findFieldByName("current_state")));
        ...
        public void shouldReturnComplexAndNestedType() throws Descriptors.DescriptorValidationException, IOException {
                ...
                System.setProperty("SINK_CONNECTOR_SCHEMA_PROTO_MESSAGE_CLASS",
                                "org.raystack.depot.TestNestedRepeatedMessageBQ");
                ...
                DynamicMessage convertedMessage = DynamicMessage.parseFrom(testDescriptor, serializedRows);
                DynamicMessage sm1 = (DynamicMessage) convertedMessage
                                .getField(testDescriptor.findFieldByName("single_message"));
                Assert.assertEquals(singleMessage.getOrderNumber(),
                                sm1.getField(sm1.getDescriptorForType().findFieldByName("order_number")));
                List<DynamicMessage> nestedMessage = (List) convertedMessage
                                .getField(testDescriptor.findFieldByName("repeated_message"));
                ...
                Assert.assertEquals(nested1.getOrderNumber(),
                                nestedMessage1.getField(sm1.getDescriptorForType().findFieldByName("order_number")));
                Assert.assertEquals(nested2.getOrderNumber(),
                                nestedMessage2.getField(sm1.getDescriptorForType().findFieldByName("order_number")));
                Assert.assertEquals(123L, convertedMessage.getField(testDescriptor.findFieldByName("number_field")));
                List<Long> repeatedNumbers = (List) convertedMessage
                                .getField(testDescriptor.findFieldByName("repeated_number_field"));
        ...
        public void shouldHaveMetadataOnPayload() throws InvalidProtocolBufferException {
                ...
                Assert.assertEquals(10L,
                                convertedMessage.getField(testDescriptor.findFieldByName("message_partition")));
                Assert.assertEquals("test-topic",
                                convertedMessage.getField(testDescriptor.findFieldByName("message_topic")));
                Assert.assertEquals(143L, convertedMessage.getField(testDescriptor.findFieldByName("message_offset")));
                Assert.assertEquals(TimeUnit.MILLISECONDS.toMicros(now.toEpochMilli()),
                                convertedMessage.getField(testDescriptor.findFieldByName("load_time")));
                Assert.assertEquals(TimeUnit.MILLISECONDS.toMicros(now.toEpochMilli()),
                                convertedMessage.getField(testDescriptor.findFieldByName("message_timestamp")));
        ...
        @Test
        public void shouldHaveMetadataOnPayloadWithNameSpace()
                ...
                ByteString serializedRows = protoPayload.getSerializedRows(0);
                DynamicMessage convertedMessage = DynamicMessage.parseFrom(testDescriptor, serializedRows);
                DynamicMessage metadata = (DynamicMessage) convertedMessage
                                .getField(testDescriptor.findFieldByName("__kafka_metadata"));
                Assert.assertEquals(10L, metadata
                                .getField(metadata.getDescriptorForType().findFieldByName("message_partition")));
                Assert.assertEquals("test-topic",
                                metadata.getField(metadata.getDescriptorForType().findFieldByName("message_topic")));
                Assert.assertEquals(143L,
                                metadata.getField(metadata.getDescriptorForType().findFieldByName("message_offset")));
                Assert.assertEquals(TimeUnit.MILLISECONDS.toMicros(now.toEpochMilli()),
                                metadata.getField(metadata.getDescriptorForType().findFieldByName("load_time")));
                Assert.assertEquals(TimeUnit.MILLISECONDS.toMicros(now.toEpochMilli()), metadata
                                .getField(metadata.getDescriptorForType().findFieldByName("message_timestamp")));
        }
                ...
                List<Message> inputList = new ArrayList<Message>() {
                        {
                                ...
                                add(new Message(null, "invalid".getBytes(StandardCharsets.UTF_8),
                                                new Tuple<>("message_offset", 12)));
        ...
        public void shouldNotConvertFiveYearsOldTimeStamp() throws IOException {
                ...
                TestMessageBQ m1 = TestMessageBQ.newBuilder()
                                .setCreatedAt(Timestamp.newBuilder().setSeconds(moreThanFiveYears.getEpochSecond())
                                                .build())
                                .addUpdatedAt(Timestamp.newBuilder().setSeconds(moreThanFiveYears.getEpochSecond())
                                                .build())
                                .addUpdatedAt(Timestamp.newBuilder().setSeconds(moreThanFiveYears.getEpochSecond())
                                                .build())
                                .build();
        ...
        public void shouldConvertAnyTimeStampIfNotPartitionColumn() throws IOException {
                ...
                TestMessageBQ m1 = TestMessageBQ.newBuilder()
                                .setCreatedAt(Timestamp.newBuilder().setSeconds(lessThanFiveYears.getEpochSecond())
                                                .build())
                                .addUpdatedAt(Timestamp.newBuilder().setSeconds(moreThanFiveYears.getEpochSecond())
                                                .build())
                                .addUpdatedAt(Timestamp.newBuilder().setSeconds(moreThanFiveYears.getEpochSecond())
        ...
        public void shouldNotConvertMoreThanOneYearFutureTimeStamp() throws IOException {
                ...
                TestMessageBQ m1 = TestMessageBQ.newBuilder()
                                .setCreatedAt(Timestamp.newBuilder().setSeconds(moreThanOneYear.getEpochSecond())
                                                .build())
                                .addUpdatedAt(Timestamp.newBuilder().setSeconds(moreThanOneYear.getEpochSecond())
                                                .build())
                                .addUpdatedAt(Timestamp.newBuilder().setSeconds(moreThanOneYear.getEpochSecond())
                                                .build())
                                .build();
