...
import org.raystack.depot.TestStructMessage;
...
public class StructProtoFieldTest {
        ...
        public void setUp() throws Exception {
                ...
                structValue = Struct.newBuilder()
                                ...
                                .putFields("struct_value", Value.newBuilder().setStructValue(
                                                Struct.newBuilder()
                                                                .putFields("child_value1",
                                                                                Value.newBuilder().setNumberValue(1.0)
                                                                                                .build())
                                                                .build())
                                                .build())
                ...
                DynamicMessage dynamicMessage = DynamicMessage.parseFrom(message.getDescriptorForType(),
                                message.toByteArray());
                Descriptors.FieldDescriptor customValues = dynamicMessage.getDescriptorForType()
                                .findFieldByName("custom_fields");
        ...
        public void shouldSerialiseRepeatedStructsIntoJson() throws InvalidProtocolBufferException {
                ...
                DynamicMessage dynamicMessage = DynamicMessage.parseFrom(message.getDescriptorForType(),
                                message.toByteArray());
                Descriptors.FieldDescriptor listCustomFieldsDescriptor = dynamicMessage.getDescriptorForType()
                                .findFieldByName("list_custom_fields");
                structProtoField = new StructProtoField(listCustomFieldsDescriptor,
                                dynamicMessage.getField(listCustomFieldsDescriptor));
