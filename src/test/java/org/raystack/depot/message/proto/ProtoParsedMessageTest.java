...
public class ProtoParsedMessageTest {
    ...
    public void shouldReturnFieldsInProperties() throws IOException {
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
    ...
    public void shouldThrowExceptionWhenFloatingPointIsNaN() throws IOException {
        ...
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.FloatTest", descriptorsMap);
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> new ProtoParsedMessage(message).getMapping(messageSchema));
    }
    ...
    public void shouldParseDurationMessageSuccessfully() throws IOException {
        ...
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
        Map<String, Object> fields = new ProtoParsedMessage(messageProtoParser.parse(message.toByteArray()))
                .getMapping(messageSchema);
        ...
        Arrays.asList(nestedMessage1, nestedMessage2).forEach(msg -> {
            ...
            try {
                fields = new ProtoParsedMessage(protoParser.parse(msg.toByteArray()))
                        .getMapping(messageParser.getSchema("org.raystack.depot.TestNestedMessageBQ", descriptorsMap));
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public void shouldParseRepeatedPrimitives() throws IOException {
        ...
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
        Map<String, Object> fields = new ProtoParsedMessage(protoParser.parse(message.toByteArray()))
                .getMapping(messageSchema);
    ...
    public void shouldParseRepeatedNestedMessages() throws IOException {
        ...
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestNestedRepeatedMessageBQ",
                descriptorsMap);
        Map<String, Object> fields = new ProtoParsedMessage(protoParser.parse(message.toByteArray()))
                .getMapping(messageSchema);
    ...
    public void shouldCacheMappingForSameSchema() throws IOException {
        ...
        TestMessageBQ message = TestMessageBQ.newBuilder()
                ...
                .addAttributes(Struct.newBuilder().putFields("name", Value.newBuilder().setStringValue("John").build())
                        .putFields("age", Value.newBuilder().setStringValue("60").build()).build())
                .build();
        MessageSchema messageSchema1 = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
        MessageSchema messageSchema2 = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
    ...
    public void shouldGetFieldByName() throws IOException {
        ...
        Object orderNumber = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("order_number", messageSchema)).getValue();
        Assert.assertEquals("order-1", orderNumber);
    }

    @Test
    public void shouldGetComplexFieldByName() throws IOException {
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestBookingLogMessage",
                descriptorsMap);
        ...
        org.raystack.depot.message.proto.converter.fields.ProtoField f = (org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("topics", messageSchema);
    ...
    public void shouldGetStructFromProto() throws IOException {
        ...
        DynamicMessage bookingLogDynamicMessage = protoParser.parse(testBookingLogMessage.toByteArray());
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(bookingLogDynamicMessage);
        Object driverPickupLocation = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("driver_pickup_location", messageSchema)).getValue();
    ...
    public void shouldGetRepeatableStructField() throws IOException {
        ...
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(protoParser.parse(message.toByteArray()));
        List<?> attributes = (List<?>) ((org.raystack.depot.message.proto.converter.fields.ProtoField) (protoParsedMessage
                .getFieldByName("attributes", messageSchema))).getValue();
    ...
    public void shouldGetNumberFields() throws IOException {
        ...
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(protoParser.parse(message.toByteArray()));
        Object discount = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("discount", messageSchema)).getValue();
        Assert.assertEquals(10000012010L, discount);
        double price = (double) ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("price", messageSchema)).getValue();
    ...
    public void shouldGetRepeatedTimeStamps() throws IOException {
        ...
        Object updatedTimeStamps = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("updated_at", messageSchema)).getValue();
    ...
    public void shouldGetFieldByNameFromNested() throws IOException {
        TestMessageBQ message1 = TestProtoUtil.generateTestMessage(now);
        Parser protoParser = StencilClientFactory.getClient().getParser(TestNestedMessageBQ.class.getName());
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestNestedMessageBQ", descriptorsMap);
        ...
        Object nestedId = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("nested_id", messageSchema)).getValue();
        Assert.assertEquals("test", nestedId);
        Object orderNumber = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("single_message.order_number", messageSchema)).getValue();
    ...
    public void shouldReturnInstantField() throws IOException {
        ...
        Assert.assertEquals(time, ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("created_at", messageSchema)).getValue());
    }
    ...
    public void shouldReturnDurationFieldInStringFormat() throws IOException {
        ...
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(parser.parse(message1.toByteArray()));
        Object tripDuration = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("trip_duration", messageSchema)).getValue();
        Assert.assertEquals(
    ...
    public void shouldReturnMapFieldAsJSONObject() throws IOException {
        ...
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestMessageBQ", descriptorsMap);
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(parser.parse(message1.toByteArray()));
        Object currentState = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("current_state", messageSchema)).getValue();
    ...
    public void shouldReturnDefaultValueForFieldIfValueIsNotSet() throws IOException {
        ...
        String orderNumber = (String) ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("order_number", messageSchema)).getValue();
    ...
    public void shouldThrowExceptionIfColumnIsNotPresentInProto() throws IOException {
        ...
        TestNestedMessageBQ nestedMessage = TestNestedMessageBQ.newBuilder().setNestedId("test")
                .setSingleMessage(message1).build();
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(protoParser.parse(nestedMessage.toByteArray()));
        String nestedId = (String) ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("nested_id", messageSchema)).getValue();
        Assert.assertEquals("test", nestedId);
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> protoParsedMessage.getFieldByName("single_message.order_id", messageSchema));
    ...
    public void shouldThrowExceptionIfColumnIsNotNested() throws IOException {
        ...
        Assert.assertEquals("test", nestedId);
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> protoParsedMessage.getFieldByName("nested_id.order_id", messageSchema));
    ...
    public void shouldThrowExceptionIfFieldIsEmpty() throws IOException {
        ...
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(dynamicMessage);
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> protoParsedMessage.getFieldByName("", messageSchema));
    ...
    public void shouldReturnRepeatedDurations() throws IOException {
        ...
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(protoParser.parse(message1.toByteArray()));
        protoParsedMessage.getMapping(messageSchema);
        Object intervals = ((org.raystack.depot.message.proto.converter.fields.ProtoField) protoParsedMessage
                .getFieldByName("intervals", messageSchema)).getValue();
    ...
    public void shouldReturnRepeatedString() throws IOException {
        TestTypesMessage message = TestTypesMessage
                ...
                .addListValues("test3")
                .build();
        org.raystack.stencil.Parser protoParser = StencilClientFactory.getClient()
                .getParser(TestTypesMessage.class.getName());
        MessageSchema messageSchema = messageParser.getSchema("org.raystack.depot.TestTypesMessage", descriptorsMap);
        ProtoParsedMessage protoParsedMessage = new ProtoParsedMessage(protoParser.parse(message.toByteArray()));
        List<?> listValues = (List<?>) ((ProtoField) protoParsedMessage.getFieldByName("list_values", messageSchema))
                .getValue();
