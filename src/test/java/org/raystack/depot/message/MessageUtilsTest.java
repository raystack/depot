...
public class MessageUtilsTest {
    ...
    public void shouldGetFieldFromNested() {
        JSONObject object = new JSONObject(
                "{\"test\" :[{\"name\":\"John\",\"age\":50},{\"name\":\"Bob\",\"age\":60},{\"name\":\"Alice\",\"active\":true,\"height\":175}]}");
    ...
    public void shouldGetRepeatedField() {
        ...
        Assert.assertEquals(175, MessageUtils.getFieldFromJsonObject("test[2].height", object, configuration));
        Assert.assertEquals("[{\"name\":\"test\",\"value\":\"sometest\"},{\"name\":\"test2\",\"value\":\"sometest2\"}]",
                MessageUtils.getFieldFromJsonObject("test[0].alist", object, configuration).toString());
        Assert.assertEquals("sometest",
                MessageUtils.getFieldFromJsonObject("test[0].alist[0].value", object, configuration));
    }
    ...
    public void shouldThrowExceptionIfInvalidPath() {
        ...
        IllegalArgumentException exception = Assert.assertThrows(IllegalArgumentException.class,
                () -> MessageUtils.getFieldFromJsonObject("testing", object, configuration));
        ...
        exception = Assert.assertThrows(IllegalArgumentException.class,
                () -> MessageUtils.getFieldFromJsonObject("test[0].testing", object, configuration));
    ...
    public void shouldThrowExceptionIfNotValid() {
        ...
        Assert.assertEquals(
                "Expected class class java.lang.Integer, but found: LogKey class: class java.lang.String, LogMessage class: class java.lang.String",
