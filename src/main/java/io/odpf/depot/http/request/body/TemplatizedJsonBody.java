...
public class TemplatizedJsonBody implements RequestBody {
    ...
    public String build(MessageContainer msgContainer) throws IOException {
        ParsedOdpfMessage parsedMessage;
    ...
    private JSONObject parse(JSONObject object, ParsedOdpfMessage parsedMessage) {
        try {
    ...
    private JSONArray parseJsonArray(JSONArray jsonArray, ParsedOdpfMessage parsedMessage) throws InvalidTemplateException {
